                            ...
                            <tbody>
                                ...
                                foreach ($record as $row) { ?>
                                    <tr>
                                        ...
                                        <td><?php echo anchor(site_url("$controller/update/" . $row->$primary_key), 'Update', "class=\"btn btn-success\" "); ?>
                                            <?php echo anchor(site_url("$controller/delete/" . $row->$primary_key), 'Delete', "class=\"btn btn-danger\" onclick=\"return confirm('Are you sure?')\" "); ?></td>
                                    </tr>
                                    <?php
                                    $i++;
                                }
