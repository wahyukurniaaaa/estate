                            ...
                            <tbody>
                                ...
                                foreach ($record as $row) { ?>
                                    <tr>
                                        ...
                                        <td><?php echo anchor(site_url("$controller/update/" . $row->id_highlight), 'Update', "class=\"btn btn-success\" "); ?>
                                            <?php echo anchor(site_url("$controller/delete/" . $row->id_highlight), 'Delete', "class=\"btn btn-danger\" onclick=\"return confirm('Are you sure?')\" "); ?></td>
                                    </tr>
                                    <?php
                                    $i++;
                                }
