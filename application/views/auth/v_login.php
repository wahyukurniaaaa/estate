...
<head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="<?= base_url() ?>assets/themes/admin_lte/plugins/iCheck/square/blue.css">
...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href="<?= base_url() ?>"><b>CGR</b>Admin</a>
        </div>
        <!-- /.login-logo -->
        <?php
...
<?php
    ...
    <!-- iCheck -->
    <script src="<?= base_url() ?>assets/themes/admin_lte/plugins/iCheck/icheck.min.js"></script>
    <script>
        $(function() {
            $('input').iCheck({
